...
def test_preflight_rejects_known_model_without_step_execution() -> None:
    args = _args(backend="real-model", model="stabilityai/stable-diffusion-3.5-medium")
...
def test_preflight_allows_z_image_real_model_target() -> None:
