...
class AsyncOmniEngine:
    ...
    def _create_default_diffusion_stage_cfg(kwargs: dict[str, Any]) -> list:
        ...
        stage_engine_args = {
            ...
            "enable_diffusion_state_manager": kwargs.get("enable_diffusion_state_manager", False),
            "diffusion_state_manager_gpu_budget_bytes": kwargs.get("diffusion_state_manager_gpu_budget_bytes", 0),
            "diffusion_state_manager_cpu_budget_bytes": kwargs.get("diffusion_state_manager_cpu_budget_bytes", 0),
            "diffusion_state_manager_theta_h": kwargs.get("diffusion_state_manager_theta_h", 0.7),
            "diffusion_state_manager_theta_w": kwargs.get("diffusion_state_manager_theta_w", 0.3),
            "diffusion_state_manager_disk_path": kwargs.get("diffusion_state_manager_disk_path", None),
